...
var gmxSessionManager = {
    ...
    requestSessionKey: function(serverHost, apiKey, apiKeyEndPoint) {
		...
		if (!(serverHost in keys)) {
            ...
            keys[serverHost] = new Promise(function(resolve, reject) {
				if (apiKey) {
					apiKeyEndPoint = apiKeyEndPoint || '/ApiKey.ashx';
					var url = L.gmxUtil.protocol + '//' + serverHost + apiKeyEndPoint + '?WrapStyle=None&Key=' + apiKey,
