...
var DataManager = L.Class.extend({
    ...
    setOptions: function(options) {
        ...
        var hostName = this.options.hostName || 'maps.kosmosnimki.ru',
        ...
        // }
        this.tileSenderPrefix = L.gmxUtil.protocol + '//' + hostName + endPoint + '?WrapStyle=None&sw=1' + '&key=' + encodeURIComponent(sessionKey);
...
// }
    ...
    _waitCheckObservers: function() {
        ...
        this._checkObserversTimer = setTimeout(this.checkObservers.bind(this), 25);
